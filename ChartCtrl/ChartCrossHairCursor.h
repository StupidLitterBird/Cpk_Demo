...
private:
	...
	**/
	CChartCrossHairCursor(CChartCtrl* pParent, CChartAxisSerie* pHorizAxis, CChartAxisSerie* pVertAxis);
	//! Destructor
	~CChartCrossHairCursor();

	//! The associated horizontal axis
	CChartAxisSerie* m_pHorizontalAxis;
	//! The associated vertical axis
	CChartAxisSerie* m_pVerticalAxis;
