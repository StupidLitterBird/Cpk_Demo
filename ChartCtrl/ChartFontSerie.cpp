...
#include "stdafx.h"
#include "ChartFontSerie.h"

CChartFontSerie::CChartFontSerie(const TChartString& strFaceName, int iPointSize)
...
CChartFontSerie::CChartFontSerie(const CChartFontSerie& copy)
{
	*this = copy;
}

CChartFontSerie::CChartFontSerie()
...
void CChartFontSerie::operator=(const CChartFontSerie& objectSrc)
{
...
void CChartFontSerie::SelectFont(CDC* pDC) const
{
	if (m_bDirty)
	{
		LOGFONT lf;
...
void CChartFontSerie::UnselectFont(CDC* pDC) const
{
	ASSERT(m_pOldFont);
...
void CChartFontSerie::SetFont(const TChartString& strFaceName,
						 int iPointSize,
						 bool bItalic, 
						 bool bBold, 
						 bool bUnderline)
...
void CChartFontSerie::SetVertical(bool bVertical)
{
