...
class CChartFontSerie
{
public:
	//! Copy constructor.
	CChartFontSerie(const CChartFontSerie& copy);
	//! Constructor
	/**
		@param strFaceName
			The font face name
		@param iPointSize
			The font point size
	**/
	CChartFontSerie(const TChartString& strFaceName, int iPointSize);
	//! Default constructor
	/**
	...
	**/
	...
	void operator=(const CChartFontSerie& objectSrc);
