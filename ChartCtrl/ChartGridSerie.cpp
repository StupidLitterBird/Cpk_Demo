...
CChartGridSerie::CChartGridSerie()
...
void CChartGridSerie::AddTick(int Position)
{
	m_lstTickPos.push_back(Position);
}

void CChartGridSerie::ClearTicks()
{
	m_lstTickPos.clear();
}

void CChartGridSerie::Draw(CDC *pDC)
{
	if (!m_bIsVisible)
		return;
	if (!pDC->GetSafeHdc() )
...
void CChartGridSerie::SetVisible(bool bVisible)
{
...
void CChartGridSerie::SetColor(COLORREF NewColor)
{
