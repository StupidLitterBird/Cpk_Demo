...
CChartStandardAxisSerie::CChartStandardAxisSerie()
 : CChartAxisSerie(), m_dFirstTickValue(0), 
...
void CChartStandardAxisSerie::SetTickIncrement(bool bAuto, double newIncrement)		
{ 
	m_bAutoTicks = bAuto;
	if (!m_bAutoTicks)
	{
...
double CChartStandardAxisSerie::GetFirstTickValue() const
{ 
...
bool CChartStandardAxisSerie::GetNextTickValue(double dCurrentTick, double& dNextTick) const
{
...
long CChartStandardAxisSerie::ValueToScreenDiscrete(double dValue) const
{
...
long CChartStandardAxisSerie::GetTickPos(double TickVal) const
{
...
TChartString CChartStandardAxisSerie::GetTickLabel(double TickValue)
{
...
void CChartStandardAxisSerie::RefreshTickIncrement()
{
	if (!m_bAutoTicks)
		return;
...
void CChartStandardAxisSerie::RefreshFirstTick()
{
	if (m_dTickIncrement!=0)
	{
		if (m_MinValue == 0)
