...
void CChartTitle::SetFont(const CChartFontSerie& newFont)
{
...
{
	CChartFontSerie newFont(strFaceName, iPointSize);
	m_mapLineFonts[iLineIndex] = newFont;
}

void CChartTitle::SetLineFont(int iLineIndex, const CChartFontSerie& newFont)
{
	m_mapLineFonts[iLineIndex] = newFont;
}
...
void CChartTitle::Draw(CDC *pDC)
{
	...
	{
		map<int, CChartFontSerie>::iterator iter = m_mapLineFonts.find(i);
